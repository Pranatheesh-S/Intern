...
const PotterySpotlight = () => {
  ...
  const playVoiceText = (text) => {
      ...
      let indianFemaleVoice = voices.find(
        (v) => (v.lang.includes("en-IN") && (v.name.includes("Female") || v.name.includes("Ravi") === false)) || v.name.includes("Veena") || v.name.includes("Google αñ╣αñ┐αñ¿αÑìαñªαÑÇ")
      );
            ...
            <div className="explanationText" style={{ display: "flex", flexDirection: "column", gap: "8px", width: "100%", minWidth: 0 }}>
              ...
              <div style={{ fontSize: "20px", color: "#0f172a", lineHeight: "1.4" }}>
                ...
                <div style={{ display: "flex", gap: "16px", marginTop: "8px", fontSize: "18px", color: "#1e3a8a", fontWeight: "bold", flexWrap: "wrap" }}>
                  <HighlightedText phrases={["Cooking", " ΓÇó "]} activeCharIndex={highlightIndex - "POTTERY WAS USED FOR VARIOUS PURPOSES. ".length} />
                  <HighlightedText phrases={["Storing food grains", " ΓÇó "]} activeCharIndex={highlightIndex - "POTTERY WAS USED FOR VARIOUS PURPOSES. Cooking, ".length} />
