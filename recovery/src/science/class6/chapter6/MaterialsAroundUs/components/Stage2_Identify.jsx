          ...
          <div style={{ 
            ...
            <div style={{ borderBottom: '2px solid rgba(122, 106, 82, 0.2)', paddingBottom: '16px', marginBottom: '12px', flexShrink: 0, display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#A64B27', color: 'white', padding: '6px 14px', borderRadius: '20px', fontSize: '0.95rem', fontWeight: '800', letterSpacing: '0.5px', boxShadow: '0 4px 10px rgba(166, 75, 39, 0.2)' }}>
                  ...
                  >
                    ...
                    <div style={{ 
                      ...
                      <div style={{ 
                        ...
                        <div style={{ width: '6px', height: '18px', background: '#A64B27', borderRadius: '2px' }} />
                        ...
                        <span style={{ fontSize: '1.05rem', fontWeight: '800', color: labelColor, display: 'flex', alignItems: 'center', gap: '6px' }}>
                          {isScanning && (
                             <motion.span
                               ...
                               style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#A64B27', display: 'inline-block' }}
                             />
                          )}
                          {labelText}
                        </span>
                        {(isScanned || isSelected) && <Check size={22} strokeWidth={3} style={{ color: '#A64B27' }} />}
                      </div>
                    </div>
                  </div>
                );
