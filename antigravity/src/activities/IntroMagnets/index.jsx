...
export default function IntroMagnets({ onBackToDashboard, onComplete }) {
  ...
  const scenes = [
    ...
    { img: '/lodestone_history.jpg', subtitle: 'From Nature to Innovation', text: <>Naturally occurring magnets discovered in ancient times are called <strong>lodestones</strong>. In the olden days, sailors used lodestone-based magnets to navigate and find directions at sea when stars were not visible. Later on, people learned how to create magnets out of pieces of iron, which eventually led to the modern <strong>artificial magnets</strong> we use today.</> },
    ...
    { img: '/IntroMagnets/scene_99.png', subtitle: 'Some Common Items with Magnets', text: <>The magnets used by sailors in the olden days were based on naturally occurring magnets, known as lodestones which were discovered in ancient times. Later on, people found out that magnets could also be made from pieces of iron. Nowadays, we have magnets made of different materials. The magnets that you find in your school laboratory and those used in pencil boxes, stickers, and toys are all artificial magnets (Fig. 4.1).</> },
    { img: '/IntroMagnets/scene_99.png', subtitle: 'Types of Magnets', text: <>Not all magnets look the same! Some are long like <strong>bar magnets</strong>, some are curved like <strong>horseshoe magnets</strong>, and others are shaped like <strong>rings</strong>. Even though they have different shapes, all magnets have the special power to attract certain materials such as iron.<br /><br />Each type of magnet is designed for a different job. Bar magnets are often used in classroom experiments, horseshoe magnets are made to provide a stronger magnetic pull, and ring magnets are found in speakers, motors, and many electronic devices. These amazing magnets help make our everyday technology work!</> }
  ];
