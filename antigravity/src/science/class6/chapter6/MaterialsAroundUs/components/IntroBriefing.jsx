...
export default function IntroBriefing({ onComplete, addXp }) {
  return (
    ...
    >
      ...
      <div>
        <span style={{ fontSize: '0.75rem', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.15em', color: 'var(--accent)' }}>Active Assignment</span>
        <h2 style={{ margin: '0.25rem 0 0.75rem 0', fontSize: '1.8rem', color: 'var(--text-heading)' }}>Mission: Material Detective</h2>
        <div style={{ height: '2px', width: '60px', background: 'var(--accent)', margin: '0.5rem auto 1rem' }} />
        <p style={{ margin: 0, fontSize: '0.95rem', color: 'var(--text-secondary)', lineHeight: '1.6', maxWidth: '520px' }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '0.5rem', fontSize: '0.8rem', color: 'var(--text-primary)' }}>
