...
<<<<<<< HEAD:src/activities/MaterialsAroundUs/components/Educational/ChapterIntroSpread.jsx
  const [currentPage, setCurrentPage] = useState(1);
  const [direction, setDirection] = useState(1);
=======
  const rightPageRef = useRef(null);
  const [isUnlocked, setIsUnlocked] = useState(true);
>>>>>>> 7e571735a97080d0b642c2776a26b3b33dba3065:archive/duplicates/legacy_src_activities/MaterialsAroundUs/components/Educational/ChapterIntroSpread.jsx
