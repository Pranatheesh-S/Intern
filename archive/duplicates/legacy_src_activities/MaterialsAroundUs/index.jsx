...
<<<<<<< HEAD:src/activities/MaterialsAroundUs/index.jsx
...
>>>>>>> 7e571735a97080d0b642c2776a26b3b33dba3065:archive/duplicates/legacy_src_activities/MaterialsAroundUs/index.jsx
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', position: 'relative' }}>
        ...
        >
          <div style={{ width: '320px', padding: '1.5rem', display: 'flex', flexDirection: 'column', height: '100%' }}>
            <h3 style={{ margin: '0 0 1.5rem 0', fontSize: '1.9rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '1px' }}>
