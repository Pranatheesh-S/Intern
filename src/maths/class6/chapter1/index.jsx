...
export default function Class6MathsChapter1({ onBackToDashboard }) {
  ...
  const tabs = [
    { id: 1, label: '1.1', title: 'What is Mathematics?', subtitle: 'Patterns everywhere — and why they matter', locked: false },
    ...
    { id: 6, label: '1.6', title: 'Shapes → Numbers', subtitle: 'Counting sides, lines and triangles', locked: currentStep < 6 },
    { id: 7, label: '🌍', title: 'Real-Life Lab', subtitle: 'Market bills · calendar magic · flowers · cricket · diyas · viral messages', locked: currentStep < 7 },
    { id: 8, label: '⭐', title: 'Summary & Final Quiz', subtitle: '15 questions · earn the last badge', locked: currentStep < 8 }
  ];
