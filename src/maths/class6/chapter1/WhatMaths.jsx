...
export default function WhatMaths() {
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem', flexWrap: 'wrap' }}>
          <h2 style={{
            ...
            <span>🌅</span> The sky never breaks its promise
          </h2>
          <span style={{
            background: '#f1f5f9',
            color: '#334155',
        ...
        <div style={{
          ...
          borderRadius: '16px',
          overflow: 'hidden',
          background: '#020111', // Deep night base
        ...
        <div style={{
          ...
          >
            {isPlaying ? (
              <>
                <Pause size={16} fill="#0f172a" /> Pause
              </>
            ) : (
              <>
                <Play size={16} fill="#0f172a" /> Play
              </>
            )}
          </button>
          ...
          <div style={{
            ...
            {formatTime(time)} · {getPhaseDescription(time)}
          </div>
        </div>
