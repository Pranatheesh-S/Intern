...
import Stage1_IntersectionJunction from './components/Stage1_IntersectionJunction';
import Stage2_ParallelRails from './components/Stage2_ParallelRails';
import Stage3_Quiz from './components/Stage3_Quiz';
import useSound from 'use-sound';

export default function ParallelIntersectingLabActivity({ onBackToDashboard }) {
  const [activeTab, setActiveTab] = useState('intersection_junction');
  const [progress, setProgress] = useState({
    intersection_junction: false,
    parallel_rails: false,
    concept_quiz: false
  });
  ...
  const tabs = [
    { 
      id: 'intersection_junction', 
      num: 1, 
      title: 'Intersecting Lines', 
      subtitle: 'Junction Builder', 
      component: <Stage1_IntersectionJunction onComplete={() => handleStageComplete('intersection_junction', 'parallel_rails')} addXp={addXp} /> 
    },
    { 
      id: 'parallel_rails', 
      num: 2, 
      title: 'Parallel Lines', 
      subtitle: 'Parallel Rails', 
      component: <Stage2_ParallelRails onComplete={() => handleStageComplete('parallel_rails', 'concept_quiz')} addXp={addXp} />,
      locked: !progress.intersection_junction 
    },
    { 
      id: 'concept_quiz', 
      num: 3, 
      ...
      locked: !progress.parallel_rails 
    }
  ];
