...
const QUIZ_QUESTIONS = [
  {
    id: 1,
    question: "What color indicates the presence of proteins in the food item?",
    options: ["Blue-black", "Red", "Violet", "Oily translucent"],
    correctAnswer: 2,
    explanation: "A violet color indicates the presence of proteins when reacting with copper sulfate and caustic soda."
  },
  {
    id: 2,
    question: "What are the two chemicals used to test for proteins?",
    options: ["Iodine and Water", "Copper sulfate and Caustic soda", "Salt and Sugar", "Vinegar and Baking soda"],
    correctAnswer: 1,
    explanation: "The Biuret test for proteins uses a few drops of copper sulfate solution and caustic soda (sodium hydroxide) solution."
  },
  {
    id: 3,
    question: "Which of these foods showed the presence of BOTH proteins and fats?",
    options: ["Bread", "Boiled Rice", "Peas", "Peanuts"],
    correctAnswer: 3,
    explanation: "Peanuts contain both fats (from our earlier paper test) and proteins (from the violet color test), showing that foods can contain multiple nutrients."
  },
  {
    id: 4,
    question: "Why should we not touch or smell the chemicals used in this test?",
    options: ["They are expensive", "They are harmful and can cause injury", "They will lose their color", "They smell bad"],
    correctAnswer: 1,
    explanation: "Chemicals like caustic soda are highly alkaline and harmful. They must be handled with care and never tasted, touched directly, or smelled."
  }
];
