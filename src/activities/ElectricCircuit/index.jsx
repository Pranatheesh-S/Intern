...
export default function ElectricCircuitActivity({ onBackToDashboard }) {
    ...
    <div>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: '1.25rem' }}>Activity 3.6</h2>
            <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Connecting a cell to a lamp</span>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
          ...
          <div>
            ...
            <p style={{ margin: '0.25rem 0 0 0', fontSize: '0.825rem', color: 'var(--text-faint)', lineHeight: '1.5' }}>
              A complete electric circuit provides a path for electricity to flow from the positive terminal to the negative terminal of the cell.
            </p>
          </div>
        </div>
      </footer>
