    ...
    <div className="main-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
          ...
          <button
            ...
            style={{
              ...
              borderColor: prediction === 'on' ? 'var(--accent)' : 'rgba(255,255,255,0.06)',
          ...
          <button
            ...
            style={{
              justifyContent: 'flex-start',
              borderColor: prediction === 'off' ? 'var(--accent)' : 'rgba(255,255,255,0.06)',
        ...
        {predictionSubmitted && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div style={{
              ...
              <h4 style={{ margin: 0, color: isPredictionCorrect ? 'var(--success)' : 'var(--danger)', display: 'flex', alignItems: 'center', gap: '0.35rem', marginBottom: '0.25rem' }}>
                {isPredictionCorrect ? '✓ Good Prediction!' : '❌ Incorrect Prediction'}
              </h4>
              <p style={{ margin: 0, color: 'var(--text-faint)', lineHeight: '1.4' }}>
                {isPredictionCorrect 
            ...
            <div style={{ background: 'var(--tab-bg)', padding: '0.85rem', borderRadius: '10px', fontSize: '0.8rem' }}>
              <span style={{ fontWeight: 'bold', color: 'var(--accent-text)', display: 'block', marginBottom: '0.2rem' }}>
                👉 RUN TEST
              </span>
      ...
      <div className="canvas-container" style={{ padding: '2rem' }}>
        ...
        >
          ...
          >
            {/* Bridge wire arm */}
            <line x1={450} y1={250} x2={450} y2={370} stroke="var(--warning)" strokeWidth={6} strokeLinecap="round" />
            <circle cx={450} cy={250} r={4} fill="var(--card-bg)" />
            <circle cx={450} cy={370} r={6} fill="var(--warning)" />
          </motion.g>
