...
export const TripodSVG = ({ className, style }) => (
...
export const SpiritLampSVG = ({ className, style, isLit = false }) => (
  <svg viewBox="0 0 100 100" className={className} style={style}>
...
export const WireGauzeSVG = ({ className, style }) => (
  <svg viewBox="0 0 100 100" className={className} style={style}>
...
export const BeakerEmptySVG = ({ className, style }) => (
...
export const BeakerFullSVG = ({ className, style, hasSoda = false }) => (
  <svg viewBox="0 0 100 120" className={className} style={style}>
    {/* Back rim */}
    <ellipse cx="50" cy="15" rx="40" ry="8" fill="rgba(255,255,255,0.2)" stroke="#ccc" strokeWidth="3" />
...
export const WaterBottleSVG = ({ className, style }) => (
  <svg viewBox="0 0 100 100" className={className} style={style}>
...
export const BakingSodaBoxSVG = ({ className, style }) => (
  <svg viewBox="0 0 100 100" className={className} style={style}>
...
export const GlassRodSVG = ({ className, style }) => (
  <svg viewBox="0 0 100 100" className={className} style={style}>
    <line x1="80" y1="10" x2="20" y2="90" stroke="rgba(255,255,255,0.7)" strokeWidth="6" strokeLinecap="round" />
  </svg>
);

export const LabStandSVG = ({ className, style, hasClamp = false }) => (
  <svg viewBox="0 0 100 200" className={className} style={style}>
    {/* Base */}
...
export const ThermometerSVG = ({ className, style }) => (
  <svg viewBox="0 0 100 200" className={className} style={style}>
    {/* Outer glass */}
