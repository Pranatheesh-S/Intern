...
export default function DetectiveNotebook({ observations }) {
  return (
    <div style={{ background: '#fdfbf7', border: '1px solid #e2e8f0', borderRadius: '4px', padding: '1rem', boxShadow: 'inset 0 0 20px rgba(0,0,0,0.02)', position: 'relative' }}>
      {/* Notebook spine */}
      <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: '20px', borderRight: '2px double #cbd5e1', background: '#f8fafc', borderRadius: '4px 0 0 4px' }} />
