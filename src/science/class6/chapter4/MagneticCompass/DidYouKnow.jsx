      ...
      {hoveredFact && (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.65rem' }}>
            ...
            <h4 style={{ margin: 0, fontSize: '1.55rem', fontWeight: 900, color: '#064E3B', letterSpacing: '-0.01em' }}>
              {hoveredFact.title}
            </h4>
          </div>
          <p style={{ margin: 0, fontSize: '1.18rem', lineHeight: '1.7', color: '#064E3B', fontWeight: 600 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', flex: 1, justifyContent: 'space-around', height: '100%' }}>
          {facts.map((fact, idx) => (
            <React.Fragment key={idx}>
              ...
              >
                <span style={{ fontSize: '1.18rem', color: '#FAFAFA' }}>👉</span>
