  ...
  return (
    <div style={{ 
      ...
      <div style={{ width: '100%', maxWidth: '1050px', display: 'flex', flexDirection: 'column' }}>
        ...
        {/* Main Quiz Card (Warm Amber Light Theme) */}
        <div className="glass-panel" style={{ 
          ...
          {/* Question Text */}
          <p style={{ fontSize: 'clamp(0.95rem, 1.3vw, 1.08rem)', margin: 0, lineHeight: '1.55', fontWeight: 700, color: '#065F46' }}>
            {currentQ.question}
          </p>
          ...
          {showResult && (
            <div style={{ marginTop: '0.5rem', animation: 'fadeIn 0.35s ease' }}>
              <div style={{ padding: '0.85rem 1.25rem', background: '#FFFBEB', borderRadius: '14px', border: '1.5px solid #FDE68A', borderLeft: '5px solid #D97706' }}>
                <h4 style={{ margin: '0 0 0.25rem 0', fontSize: '0.98rem', fontWeight: 900, color: '#064E3B' }}>Explanation</h4>
                <p style={{ margin: 0, color: '#065F46', fontSize: '0.94rem', lineHeight: '1.55', fontWeight: 600 }}>{currentQ.explanation}</p>
              </div>
