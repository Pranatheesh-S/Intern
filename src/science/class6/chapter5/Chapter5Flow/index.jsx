...
const LABS = [
  ...
  { key: "56", id: "linear_motion", n: "5.6", title: "Linear Motion", sub: "Identify objects that exhibit rectilinear motion when pushed or rolled.", tag: "Activity 5.6", icon: <Bus size={24} color="#5CE1B9" />, accent: "#5CE1B9", group: "journey" },
  { key: "57", id: "circular_motion", n: "5.7", title: "Circular Motion", sub: "Investigate how objects move along a circular path.", tag: "Activity 5.7", icon: <ArrowRightLeft size={24} color="#FFC24D" />, accent: "#FFC24D", group: "journey" },
