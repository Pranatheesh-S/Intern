...
const CustomIcons = {
  copper: (
    <svg width="40" height="40" viewBox="0 0 40 40">
      <path d="M5 20 Q10 5, 20 20 T35 20" fill="none" stroke="#d97706" strokeWidth="5" strokeLinecap="round" />
      <path d="M5 25 Q10 10, 20 25 T35 25" fill="none" stroke="#b45309" strokeWidth="5" strokeLinecap="round" opacity="0.8" />
    </svg>
  ),
  iron: (
    <svg width="40" height="40" viewBox="0 0 40 40">
  ...
  glass: (
    <svg width="60" height="60" viewBox="0 0 40 40">
      <circle cx="20" cy="20" r="14" fill="#cffafe" opacity="0.8" stroke="#06b6d4" strokeWidth="2" />
  ...
  wood: (
    <svg width="40" height="40" viewBox="0 0 40 40">
      <rect x="8" y="10" width="24" height="20" fill="#9a3412" rx="2" />
  ...
  rubber: (
    <svg width="60" height="60" viewBox="0 0 40 40">
      <ellipse cx="20" cy="20" rx="14" ry="8" fill="none" stroke="#d97706" strokeWidth="4" transform="rotate(-15 20 20)" />
      <ellipse cx="20" cy="20" rx="14" ry="8" fill="none" stroke="#fcd34d" strokeWidth="2" transform="rotate(-15 20 20)" opacity="0.8" />
    </svg>
  ),
  gold: (
    <svg width="60" height="60" viewBox="0 0 40 40">
      <circle cx="20" cy="20" r="14" fill="#facc15" stroke="#a16207" strokeWidth="2" />
      <circle cx="20" cy="20" r="10" fill="none" stroke="#fef08a" strokeWidth="2" strokeDasharray="3 2" />
      <text x="20" y="24" fontSize="12" fill="#854d0e" textAnchor="middle" fontWeight="bold">₹</text>
    </svg>
  ),
  jute: (
    <svg width="40" height="40" viewBox="0 0 40 40">
  ...
  plastic: (
    <svg width="60" height="60" viewBox="0 0 40 40">
      <rect x="6" y="16" width="28" height="8" fill="#fde047" rx="1" stroke="#ca8a04" strokeWidth="1" />
      <path d="M 8 16 V 20 M 12 16 V 18 M 16 16 V 20 M 20 16 V 18 M 24 16 V 20 M 28 16 V 18 M 32 16 V 20" stroke="#854d0e" strokeWidth="1" />
    </svg>
  )
};
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', width: '100%', height: '100%', background: '#f8fafc', padding: '1rem', borderRadius: '16px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div style={{ fontSize: '2rem', filter: lampOn ? 'drop-shadow(0 0 10px #fbbf24)' : 'none', transition: 'all 0.3s' }}>
            🛋️
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', flex: 1, minHeight: 0 }}>
        ...
        <div 
          ...
          style={{ 
            border: '2px dashed #fde047', background: '#fefce8', borderRadius: '12px',
        ...
        <div style={{ 
          ...
          {observedItem ? (
            <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '40px', filter: (lampOn && observedItem.correct === 'shiny') ? 'drop-shadow(0 0 15px #fde047)' : 'none' }}>
                {observedItem.icon}
              </div>
